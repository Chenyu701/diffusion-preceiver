...
def load_dataset(filepath: str, batch_size: int = 16, shuffle: bool = True) -> DataLoader:
    ...
    if X.dim() == 4:
    #     # Flatten channels and spatial dimensions into seq_len
...
for seed in seed_list:
    print("\n\n============================")
    print(f"Running origional data with seed {seed}")
    print("============================")
